...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\expmess on
     Windows, /home/user/dev/expmess on Linux) in a file named
     expmess@mozillamessaging.com and copy that file to
